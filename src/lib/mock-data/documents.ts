...
export const knowledgeDocuments = [
  { name: "EU Data Privacy Policy", category: "Policy · PDF", updated: "Updated Jun 12" },
  { name: "Billing Rules 2026", category: "Finance SOP · DOCX", updated: "Updated Jun 10" },
  { name: "Client Onboarding Checklist", category: "Operations · PDF", updated: "Updated Jun 08" },
  { name: "Revenue Recognition SOP", category: "Finance SOP · PDF", updated: "Updated May 29" },
  { name: "Compliance Controls", category: "Policy · PDF", updated: "Updated May 20" },
];

export const documentQueue = [
  { name: "Atlas_Invoice_2408.pdf", state: "Needs review", tone: "amber" as const },
